...
/** @hide */
	...
	static {
		__md_methods = 
			"n_getLocalSocketAddress:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;)Ljava/net/InetSocketAddress;:GetGetLocalSocketAddress_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			"n_getRemoteSocketAddress:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;)Ljava/net/InetSocketAddress;:GetGetRemoteSocketAddress_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			"n_onWebsocketClose:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;ILjava/lang/String;Z)V:GetOnWebsocketClose_Lcom_clevertap_android_sdk_java_websocket_WebSocket_ILjava_lang_String_ZHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			"n_onWebsocketCloseInitiated:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;ILjava/lang/String;)V:GetOnWebsocketCloseInitiated_Lcom_clevertap_android_sdk_java_websocket_WebSocket_ILjava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			"n_onWebsocketClosing:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;ILjava/lang/String;Z)V:GetOnWebsocketClosing_Lcom_clevertap_android_sdk_java_websocket_WebSocket_ILjava_lang_String_ZHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			"n_onWebsocketError:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;Ljava/lang/Exception;)V:GetOnWebsocketError_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Ljava_lang_Exception_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			...
			"n_onWebsocketMessage:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;Ljava/lang/String;)V:GetOnWebsocketMessage_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			"n_onWebsocketMessageBuffer:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;Ljava/nio/ByteBuffer;)V:GetOnWebsocketMessageBuffer_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Ljava_nio_ByteBuffer_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			...
			"n_onWriteDemand:(Lcom/clevertap/android/sdk/java_websocket/WebSocket;)V:GetOnWriteDemand_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings\n" +
			"";
		mono.android.Runtime.register ("Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerImplementor, CleverTapBindings", WebSocketListenerImplementor.class, __md_methods);
	}
	...
	public WebSocketListenerImplementor ()
	{
		...
		if (getClass () == WebSocketListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerImplementor, CleverTapBindings", "", this, new java.lang.Object[] {  });
	}
