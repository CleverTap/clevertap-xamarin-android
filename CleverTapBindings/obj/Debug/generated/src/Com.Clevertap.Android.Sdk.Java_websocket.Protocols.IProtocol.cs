...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Protocols {
	...
	public partial interface IProtocol : IJavaObject {
		...
		string ProvidedProtocol {
			...
			[Register ("getProvidedProtocol", "()Ljava/lang/String;", "GetGetProvidedProtocolHandler:Com.Clevertap.Android.Sdk.Java_websocket.Protocols.IProtocolInvoker, CleverTapBindings")] get;
		}
		...
		[Register ("acceptProvidedProtocol", "(Ljava/lang/String;)Z", "GetAcceptProvidedProtocol_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Protocols.IProtocolInvoker, CleverTapBindings")]
		...
		[Register ("copyInstance", "()Lcom/clevertap/android/sdk/java_websocket/protocols/IProtocol;", "GetCopyInstanceHandler:Com.Clevertap.Android.Sdk.Java_websocket.Protocols.IProtocolInvoker, CleverTapBindings")]
		...
		[Register ("toString", "()Ljava/lang/String;", "GetToStringHandler:Com.Clevertap.Android.Sdk.Java_websocket.Protocols.IProtocolInvoker, CleverTapBindings")]
		string ToString ();

	}

	[global::Android.Runtime.Register ("com/clevertap/android/sdk/java_websocket/protocols/IProtocol", DoNotGenerateAcw=true)]
	internal class IProtocolInvoker : global::Java.Lang.Object, IProtocol {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/protocols/IProtocol", typeof (IProtocolInvoker));
