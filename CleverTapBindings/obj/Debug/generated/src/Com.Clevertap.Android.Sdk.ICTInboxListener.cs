...
namespace Com.Clevertap.Android.Sdk {
	...
	public partial interface ICTInboxListener : IJavaObject {
		...
		[Register ("inboxDidInitialize", "()V", "GetInboxDidInitializeHandler:Com.Clevertap.Android.Sdk.ICTInboxListenerInvoker, CleverTapBindings")]
		...
		[Register ("inboxMessagesDidUpdate", "()V", "GetInboxMessagesDidUpdateHandler:Com.Clevertap.Android.Sdk.ICTInboxListenerInvoker, CleverTapBindings")]
		void InboxMessagesDidUpdate ();

	}

	[global::Android.Runtime.Register ("com/clevertap/android/sdk/CTInboxListener", DoNotGenerateAcw=true)]
	internal class ICTInboxListenerInvoker : global::Java.Lang.Object, ICTInboxListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/CTInboxListener", typeof (ICTInboxListenerInvoker));
