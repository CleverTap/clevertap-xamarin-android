...
namespace Com.Clevertap.Android.Sdk.Java_websocket {
	...
	public partial interface IWebSocketListener : IJavaObject {
		...
		[Register ("getLocalSocketAddress", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;)Ljava/net/InetSocketAddress;", "GetGetLocalSocketAddress_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
		...
		[Register ("getRemoteSocketAddress", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;)Ljava/net/InetSocketAddress;", "GetGetRemoteSocketAddress_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
		...
		[Register ("onWebsocketClose", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;ILjava/lang/String;Z)V", "GetOnWebsocketClose_Lcom_clevertap_android_sdk_java_websocket_WebSocket_ILjava_lang_String_ZHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
		...
		[Register ("onWebsocketCloseInitiated", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;ILjava/lang/String;)V", "GetOnWebsocketCloseInitiated_Lcom_clevertap_android_sdk_java_websocket_WebSocket_ILjava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
		...
		[Register ("onWebsocketClosing", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;ILjava/lang/String;Z)V", "GetOnWebsocketClosing_Lcom_clevertap_android_sdk_java_websocket_WebSocket_ILjava_lang_String_ZHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
		...
		[Register ("onWebsocketError", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;Ljava/lang/Exception;)V", "GetOnWebsocketError_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Ljava_lang_Exception_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
		...
		[Register ("onWebsocketMessage", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;Ljava/lang/String;)V", "GetOnWebsocketMessage_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
		...
		[Register ("onWriteDemand", "(Lcom/clevertap/android/sdk/java_websocket/WebSocket;)V", "GetOnWriteDemand_Lcom_clevertap_android_sdk_java_websocket_WebSocket_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketListenerInvoker, CleverTapBindings")]
	...
	internal class IWebSocketListenerInvoker : global::Java.Lang.Object, IWebSocketListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/WebSocketListener", typeof (IWebSocketListenerInvoker));
