...
namespace Com.Clevertap.Android.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.clevertap.android.sdk']/class[@name='CTPushNotificationReceiver']"
	[global::Android.Runtime.Register ("com/clevertap/android/sdk/CTPushNotificationReceiver", DoNotGenerateAcw=true)]
	public partial class CTPushNotificationReceiver : global::Android.Content.BroadcastReceiver {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/CTPushNotificationReceiver", typeof (CTPushNotificationReceiver));
		...
		protected CTPushNotificationReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.clevertap.android.sdk']/class[@name='CTPushNotificationReceiver']/constructor[@name='CTPushNotificationReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe CTPushNotificationReceiver ()
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.clevertap.android.sdk']/class[@name='CTPushNotificationReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
