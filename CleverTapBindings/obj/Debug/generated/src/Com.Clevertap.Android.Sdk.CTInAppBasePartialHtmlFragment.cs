...
namespace Com.Clevertap.Android.Sdk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.clevertap.android.sdk']/class[@name='CTInAppBasePartialHtmlFragment']"
	...
	public abstract partial class CTInAppBasePartialHtmlFragment : global::Com.Clevertap.Android.Sdk.CTInAppBasePartialFragment, global::Android.Views.View.IOnLongClickListener, global::Android.Views.View.IOnTouchListener {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/CTInAppBasePartialHtmlFragment", typeof (CTInAppBasePartialHtmlFragment));
		...
		protected CTInAppBasePartialHtmlFragment (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.clevertap.android.sdk']/class[@name='CTInAppBasePartialHtmlFragment']/constructor[@name='CTInAppBasePartialHtmlFragment' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe CTInAppBasePartialHtmlFragment ()
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.clevertap.android.sdk']/class[@name='CTInAppBasePartialHtmlFragment']/method[@name='onLongClick' and count(parameter)=1 and parameter[1][@type='android.view.View']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.clevertap.android.sdk']/class[@name='CTInAppBasePartialHtmlFragment']/method[@name='onTouch' and count(parameter)=2 and parameter[1][@type='android.view.View'] and parameter[2][@type='android.view.MotionEvent']]"
	...
	[global::Android.Runtime.Register ("com/clevertap/android/sdk/CTInAppBasePartialHtmlFragment", DoNotGenerateAcw=true)]
	internal partial class CTInAppBasePartialHtmlFragmentInvoker : CTInAppBasePartialHtmlFragment {

		public CTInAppBasePartialHtmlFragmentInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/CTInAppBasePartialHtmlFragment", typeof (CTInAppBasePartialHtmlFragmentInvoker));
