...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Framing {
	...
	public partial interface IFramedata : IJavaObject {
		...
		bool IsFin {
			...
			[Register ("isFin", "()Z", "GetIsFinHandler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")] get;
		}
		...
		bool IsRSV1 {
			...
			[Register ("isRSV1", "()Z", "GetIsRSV1Handler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")] get;
		}
		...
		bool IsRSV2 {
			...
			[Register ("isRSV2", "()Z", "GetIsRSV2Handler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")] get;
		}
		...
		bool IsRSV3 {
			...
			[Register ("isRSV3", "()Z", "GetIsRSV3Handler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")] get;
		}
		...
		global::Com.Clevertap.Android.Sdk.Java_websocket.Enums.Opcode Opcode {
			...
			[Register ("getOpcode", "()Lcom/clevertap/android/sdk/java_websocket/enums/Opcode;", "GetGetOpcodeHandler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")] get;
		}
		...
		global::Java.Nio.ByteBuffer PayloadData {
			...
			[Register ("getPayloadData", "()Ljava/nio/ByteBuffer;", "GetGetPayloadDataHandler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")] get;
		}
		...
		bool TransfereMasked {
			...
			[Register ("getTransfereMasked", "()Z", "GetGetTransfereMaskedHandler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")] get;
		}
		...
		[Register ("append", "(Lcom/clevertap/android/sdk/java_websocket/framing/Framedata;)V", "GetAppend_Lcom_clevertap_android_sdk_java_websocket_framing_Framedata_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Framing.IFramedataInvoker, CleverTapBindings")]
	...
	internal class IFramedataInvoker : global::Java.Lang.Object, IFramedata {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/framing/Framedata", typeof (IFramedataInvoker));
