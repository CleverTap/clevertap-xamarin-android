...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Util {
	...
	public partial class Base64 : global::Java.Lang.Object {
		...
		public partial class OutputStream : global::Java.IO.FilterOutputStream {
			...
			internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/java_websocket/util/Base64$OutputStream", typeof (OutputStream));
...
#pragma warning restore 0169
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/java_websocket/util/Base64", typeof (Base64));
		internal static new IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
