...
namespace Com.Clevertap.Android.Sdk.Java_websocket {
	...
	public partial interface IWrappedByteChannel : global::Java.Nio.Channels.IByteChannel {
		...
		bool IsBlocking {
			...
			[Register ("isBlocking", "()Z", "GetIsBlockingHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWrappedByteChannelInvoker, CleverTapBindings")] get;
		}
		...
		bool IsNeedRead {
			...
			[Register ("isNeedRead", "()Z", "GetIsNeedReadHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWrappedByteChannelInvoker, CleverTapBindings")] get;
		}
		...
		bool IsNeedWrite {
			...
			[Register ("isNeedWrite", "()Z", "GetIsNeedWriteHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWrappedByteChannelInvoker, CleverTapBindings")] get;
		}
		...
		[Register ("readMore", "(Ljava/nio/ByteBuffer;)I", "GetReadMore_Ljava_nio_ByteBuffer_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWrappedByteChannelInvoker, CleverTapBindings")]
		...
		[Register ("writeMore", "()V", "GetWriteMoreHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWrappedByteChannelInvoker, CleverTapBindings")]
		void WriteMore ();

	}

	[global::Android.Runtime.Register ("com/clevertap/android/sdk/java_websocket/WrappedByteChannel", DoNotGenerateAcw=true)]
	internal class IWrappedByteChannelInvoker : global::Java.Lang.Object, IWrappedByteChannel {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/WrappedByteChannel", typeof (IWrappedByteChannelInvoker));
