...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Handshake {
	...
	public partial interface IHandshakedata : IJavaObject {
		...
		[Register ("getContent", "()[B", "GetGetContentHandler:Com.Clevertap.Android.Sdk.Java_websocket.Handshake.IHandshakedataInvoker, CleverTapBindings")]
		byte[] GetContent ();
		...
		[Register ("getFieldValue", "(Ljava/lang/String;)Ljava/lang/String;", "GetGetFieldValue_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Handshake.IHandshakedataInvoker, CleverTapBindings")]
		...
		[Register ("hasFieldValue", "(Ljava/lang/String;)Z", "GetHasFieldValue_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Handshake.IHandshakedataInvoker, CleverTapBindings")]
		...
		[Register ("iterateHttpFields", "()Ljava/util/Iterator;", "GetIterateHttpFieldsHandler:Com.Clevertap.Android.Sdk.Java_websocket.Handshake.IHandshakedataInvoker, CleverTapBindings")]
	...
	internal class IHandshakedataInvoker : global::Java.Lang.Object, IHandshakedata {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/handshake/Handshakedata", typeof (IHandshakedataInvoker));
