...
namespace Com.Clevertap.Android.Sdk {
	...
	public partial interface IInAppNotificationListener : IJavaObject {
		...
		[Register ("beforeShow", "(Ljava/util/Map;)Z", "GetBeforeShow_Ljava_util_Map_Handler:Com.Clevertap.Android.Sdk.IInAppNotificationListenerInvoker, CleverTapBindings")]
		...
		[Register ("onDismissed", "(Ljava/util/Map;Ljava/util/Map;)V", "GetOnDismissed_Ljava_util_Map_Ljava_util_Map_Handler:Com.Clevertap.Android.Sdk.IInAppNotificationListenerInvoker, CleverTapBindings")]
	...
	internal class IInAppNotificationListenerInvoker : global::Java.Lang.Object, IInAppNotificationListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/InAppNotificationListener", typeof (IInAppNotificationListenerInvoker));
