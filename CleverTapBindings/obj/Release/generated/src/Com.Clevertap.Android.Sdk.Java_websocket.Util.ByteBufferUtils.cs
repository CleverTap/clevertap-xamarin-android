...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Util {
	...
	public partial class ByteBufferUtils : global::Java.Lang.Object {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/java_websocket/util/ByteBufferUtils", typeof (ByteBufferUtils));
		...
		public static unsafe global::Java.Nio.ByteBuffer EmptyByteBuffer {
			...
			[Register ("getEmptyByteBuffer", "()Ljava/nio/ByteBuffer;", "GetGetEmptyByteBufferHandler")]
			get {
