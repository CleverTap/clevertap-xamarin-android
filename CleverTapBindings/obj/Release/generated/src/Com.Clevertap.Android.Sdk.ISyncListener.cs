...
namespace Com.Clevertap.Android.Sdk {
	...
	public partial interface ISyncListener : IJavaObject {
		...
		[Register ("profileDataUpdated", "(Lorg/json/JSONObject;)V", "GetProfileDataUpdated_Lorg_json_JSONObject_Handler:Com.Clevertap.Android.Sdk.ISyncListenerInvoker, CleverTapBindings")]
		...
		[Register ("profileDidInitialize", "(Ljava/lang/String;)V", "GetProfileDidInitialize_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.ISyncListenerInvoker, CleverTapBindings")]
	...
	internal class ISyncListenerInvoker : global::Java.Lang.Object, ISyncListener {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/SyncListener", typeof (ISyncListenerInvoker));
