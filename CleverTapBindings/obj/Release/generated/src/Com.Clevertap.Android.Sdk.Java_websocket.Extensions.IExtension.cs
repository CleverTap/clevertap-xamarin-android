...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Extensions {
	...
	public partial interface IExtension : IJavaObject {
		...
		string ProvidedExtensionAsClient {
			...
			[Register ("getProvidedExtensionAsClient", "()Ljava/lang/String;", "GetGetProvidedExtensionAsClientHandler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")] get;
		}
		...
		string ProvidedExtensionAsServer {
			...
			[Register ("getProvidedExtensionAsServer", "()Ljava/lang/String;", "GetGetProvidedExtensionAsServerHandler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")] get;
		}
		...
		[Register ("acceptProvidedExtensionAsClient", "(Ljava/lang/String;)Z", "GetAcceptProvidedExtensionAsClient_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		...
		[Register ("acceptProvidedExtensionAsServer", "(Ljava/lang/String;)Z", "GetAcceptProvidedExtensionAsServer_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		...
		[Register ("copyInstance", "()Lcom/clevertap/android/sdk/java_websocket/extensions/IExtension;", "GetCopyInstanceHandler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		...
		[Register ("decodeFrame", "(Lcom/clevertap/android/sdk/java_websocket/framing/Framedata;)V", "GetDecodeFrame_Lcom_clevertap_android_sdk_java_websocket_framing_Framedata_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		...
		[Register ("encodeFrame", "(Lcom/clevertap/android/sdk/java_websocket/framing/Framedata;)V", "GetEncodeFrame_Lcom_clevertap_android_sdk_java_websocket_framing_Framedata_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		...
		[Register ("isFrameValid", "(Lcom/clevertap/android/sdk/java_websocket/framing/Framedata;)V", "GetIsFrameValid_Lcom_clevertap_android_sdk_java_websocket_framing_Framedata_Handler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		...
		[Register ("reset", "()V", "GetResetHandler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		void Reset ();
		...
		[Register ("toString", "()Ljava/lang/String;", "GetToStringHandler:Com.Clevertap.Android.Sdk.Java_websocket.Extensions.IExtensionInvoker, CleverTapBindings")]
		string ToString ();

	}

	[global::Android.Runtime.Register ("com/clevertap/android/sdk/java_websocket/extensions/IExtension", DoNotGenerateAcw=true)]
	internal class IExtensionInvoker : global::Java.Lang.Object, IExtension {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/extensions/IExtension", typeof (IExtensionInvoker));
