...
namespace Com.Clevertap.Android.Sdk.Java_websocket {
	...
	public partial interface IWebSocket : IJavaObject {
		...
		[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
			[Register ("getAttachment", "()Ljava/lang/Object;", "GetGetAttachmentHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		...
		[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
			[Register ("setAttachment", "(Ljava/lang/Object;)V", "GetSetAttachment_Ljava_lang_Object_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] set;
		}
		...
		global::Com.Clevertap.Android.Sdk.Java_websocket.Drafts.Draft Draft {
			...
			[Register ("getDraft", "()Lcom/clevertap/android/sdk/java_websocket/drafts/Draft;", "GetGetDraftHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		bool HasBufferedData {
			...
			[Register ("hasBufferedData", "()Z", "GetHasBufferedDataHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		bool IsClosed {
			...
			[Register ("isClosed", "()Z", "GetIsClosedHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		bool IsClosing {
			...
			[Register ("isClosing", "()Z", "GetIsClosingHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		bool IsFlushAndClose {
			...
			[Register ("isFlushAndClose", "()Z", "GetIsFlushAndCloseHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		bool IsOpen {
			...
			[Register ("isOpen", "()Z", "GetIsOpenHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		global::Java.Net.InetSocketAddress LocalSocketAddress {
			...
			[Register ("getLocalSocketAddress", "()Ljava/net/InetSocketAddress;", "GetGetLocalSocketAddressHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		global::Com.Clevertap.Android.Sdk.Java_websocket.Enums.ReadyState ReadyState {
			...
			[Register ("getReadyState", "()Lcom/clevertap/android/sdk/java_websocket/enums/ReadyState;", "GetGetReadyStateHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		global::Java.Net.InetSocketAddress RemoteSocketAddress {
			...
			[Register ("getRemoteSocketAddress", "()Ljava/net/InetSocketAddress;", "GetGetRemoteSocketAddressHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		string ResourceDescriptor {
			...
			[Register ("getResourceDescriptor", "()Ljava/lang/String;", "GetGetResourceDescriptorHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")] get;
		}
		...
		[Register ("close", "()V", "GetCloseHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		void Close ();
		...
		[Register ("close", "(I)V", "GetClose_IHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		void Close (int p0);
		...
		[Register ("close", "(ILjava/lang/String;)V", "GetClose_ILjava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		...
		[Register ("closeConnection", "(ILjava/lang/String;)V", "GetCloseConnection_ILjava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		...
		[Register ("send", "([B)V", "GetSend_arrayBHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		void Send (byte[] p0);
		...
		[Register ("send", "(Ljava/lang/String;)V", "GetSend_Ljava_lang_String_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		void Send (string p0);
		...
		[Register ("send", "(Ljava/nio/ByteBuffer;)V", "GetSend_Ljava_nio_ByteBuffer_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		...
		[Register ("sendFragmentedFrame", "(Lcom/clevertap/android/sdk/java_websocket/enums/Opcode;Ljava/nio/ByteBuffer;Z)V", "GetSendFragmentedFrame_Lcom_clevertap_android_sdk_java_websocket_enums_Opcode_Ljava_nio_ByteBuffer_ZHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		...
		[Register ("sendFrame", "(Lcom/clevertap/android/sdk/java_websocket/framing/Framedata;)V", "GetSendFrame_Lcom_clevertap_android_sdk_java_websocket_framing_Framedata_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		...
		[Register ("sendFrame", "(Ljava/util/Collection;)V", "GetSendFrame_Ljava_util_Collection_Handler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		...
		[Register ("sendPing", "()V", "GetSendPingHandler:Com.Clevertap.Android.Sdk.Java_websocket.IWebSocketInvoker, CleverTapBindings")]
		void SendPing ();
	...
	internal class IWebSocketInvoker : global::Java.Lang.Object, IWebSocket {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/WebSocket", typeof (IWebSocketInvoker));
