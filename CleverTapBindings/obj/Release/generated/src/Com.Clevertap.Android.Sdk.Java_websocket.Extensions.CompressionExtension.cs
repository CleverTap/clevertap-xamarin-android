...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Extensions {
	...
	public abstract partial class CompressionExtension : global::Com.Clevertap.Android.Sdk.Java_websocket.Extensions.DefaultExtension {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/java_websocket/extensions/CompressionExtension", typeof (CompressionExtension));
	...
	internal partial class CompressionExtensionInvoker : CompressionExtension {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/java_websocket/extensions/CompressionExtension", typeof (CompressionExtensionInvoker));
