...
namespace Com.Clevertap.Android.Sdk.Ab_testing.Gesture {
	...
	public partial class ConnectionGesture : global::Java.Lang.Object, global::Android.Hardware.ISensorEventListener {
		...
		public partial interface IOnGestureListener : IJavaObject {
			...
			[Register ("onGesture", "()V", "GetOnGestureHandler:Com.Clevertap.Android.Sdk.Ab_testing.Gesture.ConnectionGesture/IOnGestureListenerInvoker, CleverTapBindings")]
			void OnGesture ();
		...
		internal class IOnGestureListenerInvoker : global::Java.Lang.Object, IOnGestureListener {
			...
			internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/ab_testing/gesture/ConnectionGesture$OnGestureListener", typeof (IOnGestureListenerInvoker));
...
#pragma warning restore 0649
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/ab_testing/gesture/ConnectionGesture", typeof (ConnectionGesture));
