...
namespace Com.Clevertap.Android.Sdk {
	...
	public partial interface IInAppNotificationButtonListener : IJavaObject {
		...
		[Register ("onInAppButtonClick", "(Ljava/util/HashMap;)V", "GetOnInAppButtonClick_Ljava_util_HashMap_Handler:Com.Clevertap.Android.Sdk.IInAppNotificationButtonListenerInvoker, CleverTapBindings")]
	...
	internal class IInAppNotificationButtonListenerInvoker : global::Java.Lang.Object, IInAppNotificationButtonListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/InAppNotificationButtonListener", typeof (IInAppNotificationButtonListenerInvoker));
