...
namespace Com.Clevertap.Android.Sdk {
	...
	public partial interface ICTExperimentsListener : IJavaObject {
		...
		[Register ("CTExperimentsUpdated", "()V", "GetCTExperimentsUpdatedHandler:Com.Clevertap.Android.Sdk.ICTExperimentsListenerInvoker, CleverTapBindings")]
	...
	internal class ICTExperimentsListenerInvoker : global::Java.Lang.Object, ICTExperimentsListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/clevertap/android/sdk/CTExperimentsListener", typeof (ICTExperimentsListenerInvoker));
