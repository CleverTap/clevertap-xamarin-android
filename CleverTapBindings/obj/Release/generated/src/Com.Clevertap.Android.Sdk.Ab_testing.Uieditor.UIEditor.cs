...
namespace Com.Clevertap.Android.Sdk.Ab_testing.Uieditor {
	...
	public partial class UIEditor : global::Java.Lang.Object {
		...
		public partial class ActivitySet : global::Java.Lang.Object {
			...
			internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/ab_testing/uieditor/UIEditor$ActivitySet", typeof (ActivitySet));
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/ab_testing/uieditor/UIEditor", typeof (UIEditor));
		internal static new IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
