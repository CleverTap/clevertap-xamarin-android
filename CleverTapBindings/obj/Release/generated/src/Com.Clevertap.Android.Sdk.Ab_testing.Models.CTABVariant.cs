...
namespace Com.Clevertap.Android.Sdk.Ab_testing.Models {
	...
	public partial class CTABVariant : global::Java.Lang.Object {
		...
		public sealed partial class CTVariantAction : global::Java.Lang.Object {
			...
			internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/ab_testing/models/CTABVariant$CTVariantAction", typeof (CTVariantAction));
			...
			public unsafe global::Org.Json.JSONObject Change {
				...
				[Register ("getChange", "()Lorg/json/JSONObject;", "GetGetChangeHandler")]
				get {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/clevertap/android/sdk/ab_testing/models/CTABVariant", typeof (CTABVariant));
		internal static new IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
